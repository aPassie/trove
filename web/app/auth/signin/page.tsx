      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs text-[#F0EDE6]/60 leading-relaxed font-light">
            Authenticate via Setu secure gateway using your DigiLocker identity to initiate client-side scan.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center bg-[#050505] border border-white/[0.06] rounded-2xl p-4 w-full h-[100px] gap-2 select-none relative overflow-hidden">
          ...
          <span className="font-mono text-[8px] uppercase tracking-wider text-[#F0EDE6]/30 z-10 font-black">DigiLocker Secure Link</span>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center bg-black border border-white/10 text-[#F0EDE6] text-xs sm:text-sm font-mono font-bold uppercase tracking-wider px-5 py-3.5 hover:bg-white/[0.04] transition-all cursor-pointer"
            style={{ clipPath: 'polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))' }}
          >
